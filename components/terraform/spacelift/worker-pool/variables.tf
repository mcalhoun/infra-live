...
variable "vpc_id" {
  type        = string
  description = "VPC ID. If not specified, it will be looked up from remote state"
  default     = null
}

variable "vpc_private_subnet_ids" {
  type        = list(string)
  description = "List of private subnet IDs. If not specified, it will be looked up from remote state"
  default     = null
}

variable "remote_state_iam_role" {
  type        = string
  description = "IAM role ARN to access the remote state. If not specified, it will be looked up from remote state"
  default     = null
}

variable "identity_account_id" {
  type        = string
  description = "AWS account ID of the identity account. If not specified, it will be looked up from remote state"
  default     = null
}

variable "ecr_repo_arn" {
  type        = string
  description = "ECR repository ARN. If not specified, it will be looked up from remote state"
  default     = null
}

variable "ecr_repo_url" {
  type        = string
  description = "ECR repository URL. If not specified, it will be looked up from remote state"
  default     = null
}
...
variable "space_id" {
  type        = string
  description = "The Spacelift Space ID to use for the Spacelift worker"
  default     = "root"
}
